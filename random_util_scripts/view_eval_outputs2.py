...
# CHECKPOINTS = [50_000, 100_000, 150_000, 200_000, 250_000, 300_000, 500_000, 600_000]
NUM_SAMPLES = [1]
            ...
            for vf in VFS:
                for vf_checkpoint in VF_CHECKPOINTS:
                    for num_samples in NUM_SAMPLES:
                        ...
                        # objects = wr.s3.list_objects(f's3://kyle-sagemaker-training-outputs/eval-outputs/jax_model/public_checkpoint/diffusion_ng/seed_42/20240225_053306/checkpoint_{checkpoint}/no_vf/checkpoint_none/50_denoising_steps/1_samples/notmpensb/*/results.txt')
                        # objects_json = wr.s3.list_objects(f's3://kyle-sagemaker-training-outputs/eval-outputs/jax_model/public_checkpoint/diffusion_ng/seed_42/20240225_053306/checkpoint_{checkpoint}/no_vf/checkpoint_none/50_denoising_steps/1_samples/notmpensb/*/results.json')
