...
# from susie_functions import sampling, scheduling
# from susie_functions.jax_utils import replicate
...
def create_sample_fn(
    ...
    def sample(image, prompt, prompt_w=prompt_w, context_w=context_w, num_samples=num_samples):
        nonlocal rng
